  ...
  <div class="container-fluid p-5">
    ...
    <div class="col-lg-3" style="background-color: black; border-radius: 20px; color: white;overflow: hidden; ">
      ...
      <div class="contact-icon" style="float: right;margin-top: 25px;margin-right: 30px;">
        <a href="404.html"><img src="@images/icon-fb.png" style="width: 50px;"></a>
        <a href="404.html"><img src="@images/icon-line.png" style="width: 50px;"></a>
      </div>
    </div>
    <br>
    <br>
    ...
    <form id="form" action="https://formsubmit.co/363367bd126ea0fd2b58f2b247f113a5" method="post"
      ...
      <div class="form-group" style="margin-bottom: 10px;">
        <input type="email" name="email" class="form-control" id="email" placeholder="email" v-model="email" ref="email">
      </div>
      ...
      <div class="mb-3">
        <input class="form-control" type="file" accept="image/*" id="formFile" name="file" ref="image"
          @change="fileUpdate">
        <img id="formImg" alt="form image" style="" v-if="preview" :src="preview" width="300" />
      </div>
