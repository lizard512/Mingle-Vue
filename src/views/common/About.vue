    ...
    <section class="pt-7">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-md-6 text-end"><img class="pt-7 pt-md-0 img-fluid" src="@images/about/hero/hero-img.png"
                        alt="" /></div>
            </div>
        </div>
    </section>
    ...
    <section class="pt-5 pt-md-9 mb-6" id="feature">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-sm-6 mb-2"> <img class="mb-3 ms-n3" src="@images/about/category/icon2.png" width="75"
                        alt="Feature" />
                ...
                <div class="col-lg-3 col-sm-6 mb-2"> <img class="mb-3 ms-n3" src="@images/about/category/icon3.png" width="75"
                        alt="Feature" />
                    <h4 class="mb-3">Preference tests</h4>
                    <p class="mb-0 fw-medium text-secondary">The Myspace page defines the individual.</p>
                </div>
                <div class="col-lg-3 col-sm-6 mb-2"> <img class="mb-3 ms-n3" src="@images/about/category/icon4.png" width="75"
                        alt="Feature" />
    ...
    <section class="pt-5" id="validation">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6"><img class="img-fluid" src="@images/about/validation/validation.png" alt="" /></div>
            </div>
        </div><!-- end of .container-->
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="d-flex align-items-center mb-3"> <img class="me-sm-4 me-2" src="@images/about/manager/tick.png"
                            width="35" alt="tick" />
                        <p class="fw-medium mb-0 text-secondary">Never worry about overpaying for your<br />energy again.
                        </p>
                    </div>
                    <div class="d-flex align-items-center mb-3"> <img class="me-sm-4 me-2" src="@images/about/manager/tick.png"
                            width="35" alt="tick" />
                        <p class="fw-medium mb-0 text-secondary">We will only switch you to energy companies<br />that we
                            trust and will treat you right</p>
                    </div>
                    <div class="d-flex align-items-center mb-3"><img class="me-sm-4 me-2" src="@images/about/manager/tick.png"
                            width="35" alt="tick" />
                        <p class="fw-medium mb-0 text-secondary"> We track the markets daily and know where the<br />savings
                            are.</p>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4 mb-4">
                    <div class="card"><img class="card-img-top" src="@images/about/marketing/marketing01.png" alt="" />
                ...
                <div class="col-md-4 mb-4">
                    <div class="card"><img class="card-img-top" src="@images/about/marketing/marketing02.png" alt="" />
                        <div class="card-body ps-0">
                            <p class="text-secondary">By <a class="fw-bold text-decoration-none me-1"
                                    href="#">Abdullah</a>|<span class="ms-1">03 March 2019</span></p>
                ...
                <div class="col-md-4 mb-4">
                    <div class="card"><img class="card-img-top" src="@images/about/marketing/marketing03.png" alt="" />
                        <div class="card-body ps-0">
                            <p class="text-secondary">By <a class="fw-bold text-decoration-none me-1"
                                    href="#">Abdullah</a>|<span class="ms-1">03 March 2019</span></p>
